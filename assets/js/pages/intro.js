...
\================================================== */
    ...
    function updateSlogan() {
      ...
      const scale = reduceMotion
        ? 1
        : 1 + eased * (mobile ? 1.15 : 2);

      const moveX = reduceMotion
        ? 0
        : eased * (mobile ? -0.5 : -1.5);

      const moveY = reduceMotion
        ? 0
        : eased * (mobile ? -10 : -20);

      const textMove = reduceMotion
        ? 0
        : eased * (mobile ? 14 : 25);

      const baseTextY = mobile ? -56 : -63;
      ...
      sloganContent.style.transform =
        ...
        `translate(-50%, calc(${baseTextY}% - ${textMove}px))`;
...
\================================================== */
    ...
    if (!isMobileIntro && typeof window.Lenis === 'function') {
